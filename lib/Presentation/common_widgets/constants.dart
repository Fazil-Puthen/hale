...
import 'package:hale/Presentation/homescreen.dart/widgets/category_sliver_body.dart';
import 'package:hale/Presentation/homescreen.dart/widgets/home_sliver_body.dart';
import 'package:hale/Presentation/homescreen.dart/widgets/saved_sliver_body.dart';
import 'package:hale/Presentation/homescreen.dart/widgets/shop_sliver_body.dart';

final cardfont=GoogleFonts.aBeeZee(fontSize: 14,fontWeight:FontWeight.w300,color: Colors.black);
...
final pricefont=GoogleFonts.aBeeZee(fontSize: 17,fontWeight: FontWeight.bold,color: Colors.white);
...
final List<String> category = ['Pants','T-shirts','Shirts','Polos','Trousers','Joggers','Inners','Kutas'];
const List<Widget> navigationwidgets=[HomeWidget(),CategoryWidget(),ShopWidget(),WishWidget()];
